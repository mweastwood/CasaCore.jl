...
for T in (Bool, Int32, Float32, Float64, Complex64)
    ...
    @eval function write_keyword!(table::Table, column::String, keyword::Keyword, input::$T)
...
function write_keyword!(table::Table, column::String, keyword::Keyword, input::String)
